...
const CoachDetails = defineAsyncComponent(() => ('./pages/coaches/CoachDetails.vue'));

const CoachRegistration = defineAsyncComponent(()=>('./pages/coaches/CoachRegistration.vue'));
